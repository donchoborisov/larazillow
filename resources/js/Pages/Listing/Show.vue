<template>
  <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
    ...
    <EmptyState v-else class="md:col-span-7 flex items-center border border-cyan-200 rounded-md w-full">No Images</EmptyState>
      ...
      <Box>
        ...
        <div class="p-2">
          ...
          <input
            ...
            type="range" min="0.1" max="30" step="0.1" class="w-full h-4 bg-gray-200 rounded-lg
          ...
          <input
            ...
            type="range" min="3" max="35" step="1" class="w-full h-4 bg-gray-200 rounded-lg
          appearance-none cursor-pointer dark:bg-gray-700"
          />
        </div>
        <div class="text-gray-600 dark:text-gray-300 mt-2 p-2">
