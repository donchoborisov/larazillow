<template>
  ...
  <section v-if="listings.data.length" class="grid grid-cols-1 lg:grid-cols-2 gap-2">
    <Box v-for="listing in listings.data" :key="listing.id" class="p-2" :class="{'border-dashed' : listing.deleted_at}">
      <div class="flex flex-col md:flex-row gap-2 md:items-center justify-between">
        ...
        <section>
          <div class="flex items-center gap-1 text-gray dark:text-gray-300">
            <a
          ...
          <div class="mt-2">
            <Link
              ...
              class="block text-center w-full btn-outline text-xs font-medium"
            >
